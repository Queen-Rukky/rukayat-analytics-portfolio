...
- **Headline KPIs**: 256 total orders, 19,955.86 total units, $53,152.37 total revenue
...
- **Data quality**: of 256 orders, the vast majority passed validation, with only a thin slice flagged as outlier or invalid, visible directly on the Quality_flag by orders chart
